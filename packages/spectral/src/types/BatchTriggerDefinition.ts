 ...
 * next page.
 */
export interface BatchTriggerBaseReturn<
  TItem,
...
export interface BatchTriggerBranchingReturn<
  TItem,
  TPaginationState extends Record<string, unknown> = Record<string, unknown>,
...
export interface BatchTriggerOnDeploy<
  ...
  TOnDeployPaginationState extends Record<string, unknown> = Record<string, unknown>,
> {
