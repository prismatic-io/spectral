...
expectType<InputCleanFunction<Connection | null | undefined>>(connectionInput.clean);
...
expectType<InputCleanFunction<ConditionalExpression | null | undefined>>(conditionalInput.clean);
